...
<div class="svc">
  ...
  <section class="svc-hero">
    <div class="svc-pill"><span class="svc-dot"></span>Taking on new projects · replies within a day</div>
    <h1>Work with me</h1>
    <p class="svc-lede">I take iOS, macOS, and watchOS apps from idea to the App Store — and help teams rescue, modernize, and launch the ones they already have.</p>
    <div class="svc-hero-actions">
      <a class="svc-btn svc-btn--primary" href="#contact">Start a project →</a>
      <a class="svc-btn svc-btn--ghost" href="/portfolio/">See recent work</a>
    </div>
    <div class="svc-stats">
      <div class="svc-stat"><strong>10</strong><span>apps shipped</span></div>
      <div class="svc-stat"><strong>2014</strong><span>building with Swift since</span></div>
      <div class="svc-stat"><strong>11,000+</strong><span>developers taught</span></div>
      <div class="svc-stat"><strong>AI</strong><span>accelerated delivery</span></div>
    </div>
  </section>

  <!-- Services -->
  <section class="svc-section">
    <p class="svc-kicker">What I can help you with</p>
    <h2>Four ways we can work together</h2>
    <p class="svc-sub">10 apps shipped across iPhone, iPad, Mac, and Apple Watch. Building with Swift since 2014 — now AI-accelerated, so projects move faster without cutting corners.</p>

    <div class="svc-grid">
      <div class="svc-card">
        <div class="svc-card-head"><span class="svc-num">01</span><span class="svc-rule"></span></div>
      ...
      <div class="svc-card">
        <div class="svc-card-head"><span class="svc-num">02</span><span class="svc-rule"></span></div>
      ...
      <div class="svc-card">
        <div class="svc-card-head"><span class="svc-num">03</span><span class="svc-rule"></span></div>
      ...
      <div class="svc-card">
        <div class="svc-card-head"><span class="svc-num">04</span><span class="svc-rule"></span></div>
  ...
  <!-- How we'll work -->
  <section class="svc-section svc-section--tint">
    <p class="svc-kicker">How we'll work</p>
    <h2>A clear path from first email to launch</h2>
    <ol class="svc-steps">
  ...
  <section class="svc-section">
    ...
    <div class="svc-quotes">
      ...
      {% endfor %}
      <div class="svc-quote svc-quote--callout">
        <strong>10+</strong>
        <span>apps shipped to the App Store under my own name — I sell what I build.</span>
        <a href="/portfolio/">See the portfolio →</a>
      </div>
    </div>
  </section>
  ...
  <!-- Contact -->
  <section id="contact" class="svc-section">
    <p class="svc-kicker">Start a project</p>
    <h2>Tell me what you're building</h2>
    <p class="svc-sub">I take on a small number of projects at a time and reply personally, usually within a day.</p>
    ...
    <form class="contact-form" id="project-form" action="https://formspree.io/f/mrewrblo" method="POST">
      ...
      <button type="submit" class="svc-btn svc-btn--primary">Send inquiry →</button>
